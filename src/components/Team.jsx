        ...
        <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24">
          <div className="space-y-12">
            <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
              <h2 className="text-3xl font-extrabold text-[#B98221] tracking-tight text-center sm:text-4xl">Meet our Tutors</h2>
                  ...
                  <div className="space-y-6 xl:space-y-10">
                    ...
                    <div className="space-y-2 xl:flex xl:items-center xl:justify-between">
                      <div className="font-medium text-lg leading-6 space-y-1">
                        ...
                        <p className="text-[#B98221]">{person.role}</p>
                      </div>
  
                      <ul role="list" className="flex justify-center space-x-5">
                        <li>
                          <a href={person.twitterUrl} className="text-[#B98221] hover:text-gray-300">
                        ...
                        <li>
                          <a href={person.linkedinUrl} className="text-[#B98221] hover:text-gray-300">
